 ...
 */
public class EduBotConfiguration extends RobotConfiguration {
    // Left motors
     ...
     * @return
     */
    public static EduBotConfiguration newConfig(HardwareMap hardwareMap, Telemetry telemetry) {

        EduBotConfiguration config = new EduBotConfiguration();
